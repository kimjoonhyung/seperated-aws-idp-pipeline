...
# Resolve CloudFormation template: prefer the copy next to this script.
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
if [[ -f "$SCRIPT_DIR/destroy-codebuild.yml" ]]; then
    TEMPLATE_FILE="$SCRIPT_DIR/destroy-codebuild.yml"
    echo ""
